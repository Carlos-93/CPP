...
void attackEspadaToEnemy(int& enemiesHPS, bool& enemiesStatus, string& enemiesNames) {
...
void attackMagiaToEnemy(int& enemiesHPS, bool& enemiesStatus, string& enemiesNames) {
...
void attackFlechaToEnemy(int& enemiesHPS, bool& enemiesStatus, string& enemiesNames) {
...
void attackEnemiesToHero(int& enemiesHPS, int& enemiesDamage, string& enemiesNames) {
    if (enemiesHPS > 0) {
...
void switchToEnemies(int& enemiesHPS, bool& enemiesStatus, string& enemiesNames) {
    ...
    case 1:
        ...
        attackEspadaToEnemy(enemiesHPS, enemiesStatus, enemiesNames);
        break;

    case 2:
        //PlaySound(TEXT("Magia.wav"), NULL, SND_FILENAME | SND_SYNC);
        attackMagiaToEnemy(enemiesHPS, enemiesStatus, enemiesNames);
        break;

    case 3:
        //PlaySound(TEXT("Flecha.wav"), NULL, SND_FILENAME | SND_SYNC);
        attackFlechaToEnemy(enemiesHPS, enemiesStatus, enemiesNames);
        break;
...
void attackToEnemy(int& enemiesHPS, int& enemiesDamages, bool& enemiesStatus, string& enemiesNames) {
    ...
    if (enemiesStatus) {
        ...
        attackEnemiesToHero(enemiesHPS, enemiesDamages, enemiesNames);
    }
}
void attackToEnemies1() {
    ...
    if (enemyselect == 1) {
        ...
        attackEnemiesToHero(enemyHP1, enemyDamage1, enemyName1);
        attackEnemiesToHero(enemyHP2, enemyDamage2, enemyName2);
    }
}
...
void battleToEnemy1() {
    lifePointsHeroEnemy(enemyHP1, enemyName1);
    attackToEnemy(enemyHP1, enemyDamage1, enemyIsAlive1, enemyName1);

    system("pause");
    system("cls");
}
void battleToEnemy2() {
    lifePointsHeroEnemy(enemyHP2, enemyName2);
    attackToEnemy(enemyHP2, enemyDamage2, enemyIsAlive2, enemyName2);
